...
function create_each_block(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(a, file, 63, 4, 1301);
			add_location(br0, file, 64, 4, 1348);
			add_location(br1, file, 66, 4, 1376);
			add_location(br2, file, 67, 4, 1387);
		},
...
function create_fragment(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(input0, file, 54, 0, 1081);
			add_location(br0, file, 55, 0, 1158);
			attr(input1, "class", "blog-description svelte-1uev76t");
			add_location(input1, file, 56, 0, 1165);
			add_location(br1, file, 57, 0, 1234);
			add_location(br2, file, 58, 0, 1241);
			add_location(br3, file, 59, 0, 1248);
			attr(div, "id", "posts");
			add_location(div, file, 61, 0, 1256);
...
export default Blog;
export { preload };
//# sourceMappingURL=Blog-1fcb08c7.js.map
