...
function create_each_block(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(a, file, 62, 4, 1279);
			add_location(br0, file, 63, 4, 1326);
			add_location(br1, file, 65, 4, 1354);
			add_location(br2, file, 66, 4, 1365);
		},
...
function create_fragment(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(input0, file, 53, 0, 1059);
			add_location(br0, file, 54, 0, 1136);
			attr(input1, "class", "blog-description svelte-1uev76t");
			add_location(input1, file, 55, 0, 1143);
			add_location(br1, file, 56, 0, 1212);
			add_location(br2, file, 57, 0, 1219);
			add_location(br3, file, 58, 0, 1226);
			attr(div, "id", "posts");
			add_location(div, file, 60, 0, 1234);
...
export default Blog;
export { preload };
//# sourceMappingURL=Blog-7f00c105.js.map
