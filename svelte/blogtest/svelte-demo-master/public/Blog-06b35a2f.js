...
function create_each_block(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(a, file, 61, 4, 1268);
			add_location(br0, file, 62, 4, 1315);
			add_location(br1, file, 64, 4, 1343);
			add_location(br2, file, 65, 4, 1354);
		},
...
function create_fragment(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(input0, file, 51, 0, 1044);
			add_location(p, file, 52, 0, 1112);
			add_location(br0, file, 53, 0, 1134);
			attr(input1, "class", "blog-description svelte-o63xsf");
			add_location(input1, file, 54, 0, 1141);
			add_location(br1, file, 55, 0, 1201);
			add_location(br2, file, 56, 0, 1208);
			add_location(br3, file, 57, 0, 1215);
			attr(div, "id", "posts");
			add_location(div, file, 59, 0, 1223);
...
export default Blog;
export { preload };
//# sourceMappingURL=Blog-06b35a2f.js.map
