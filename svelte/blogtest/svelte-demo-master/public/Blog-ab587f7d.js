...
function create_each_block(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(a, file, 66, 4, 1338);
			add_location(br0, file, 67, 4, 1385);
			add_location(br1, file, 69, 4, 1413);
			add_location(br2, file, 70, 4, 1424);
		},
...
function create_fragment(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(input0, file, 56, 0, 1121);
			add_location(p, file, 57, 0, 1189);
			add_location(br0, file, 58, 0, 1204);
			attr(input1, "class", "blog-description svelte-1uev76t");
			add_location(input1, file, 59, 0, 1211);
			add_location(br1, file, 60, 0, 1271);
			add_location(br2, file, 61, 0, 1278);
			add_location(br3, file, 62, 0, 1285);
			attr(div, "id", "posts");
			add_location(div, file, 64, 0, 1293);
...
export default Blog;
export { preload };
//# sourceMappingURL=Blog-ab587f7d.js.map
