...
function create_each_block(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(a, file, 66, 4, 1381);
			add_location(br0, file, 67, 4, 1428);
			add_location(br1, file, 69, 4, 1456);
			add_location(br2, file, 70, 4, 1467);
		},
...
function create_fragment(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(input0, file, 57, 0, 1170);
			add_location(br0, file, 58, 0, 1238);
			attr(input1, "class", "blog-description svelte-1uev76t");
			add_location(input1, file, 59, 0, 1245);
			add_location(br1, file, 60, 0, 1314);
			add_location(br2, file, 61, 0, 1321);
			add_location(br3, file, 62, 0, 1328);
			attr(div, "id", "posts");
			add_location(div, file, 64, 0, 1336);
...
export default Blog;
export { preload };
//# sourceMappingURL=Blog-40867d41.js.map
