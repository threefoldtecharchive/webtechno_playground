...
function create_each_block(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(br0, file, 58, 4, 1092);
			add_location(br1, file, 60, 4, 1120);
			add_location(br2, file, 61, 4, 1131);
		},
...
function create_fragment(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(input0, file, 48, 0, 825);
			add_location(br0, file, 49, 0, 902);
			attr(input1, "class", "blog-description svelte-o63xsf");
			add_location(input1, file, 50, 0, 909);
			add_location(br1, file, 51, 0, 978);
			add_location(br2, file, 52, 0, 985);
			add_location(br3, file, 53, 0, 992);
			attr(div, "id", "posts");
			add_location(div, file, 55, 0, 1000);
			attr(input2, "class", "new-post-title");
			attr(input2, "placeholder", "Title");
			add_location(input2, file, 66, 0, 1201);
			add_location(br4, file, 67, 0, 1300);
			attr(input3, "class", "new-post-body");
			attr(input3, "placeholder", "Body");
			add_location(input3, file, 68, 0, 1307);
			add_location(button, file, 69, 0, 1384);
			attr(form, "id", "newPost");
			add_location(form, file, 65, 0, 1156);
...
export default Blog;
//# sourceMappingURL=Blog-3919fbde.js.map
