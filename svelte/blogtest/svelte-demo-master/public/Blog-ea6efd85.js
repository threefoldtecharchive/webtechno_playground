...
function create_each_block(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(a, file, 55, 6, 1036);
			add_location(li, file, 54, 4, 1025);
		},
...
function create_fragment(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(br, file, 48, 0, 918);
			add_location(input1, file, 49, 0, 925);
			add_location(h1, file, 50, 0, 969);
			attr(ul, "class", "svelte-12zu22z");
			add_location(ul, file, 52, 0, 992);
...
export default Blog;
export { preload };
//# sourceMappingURL=Blog-ea6efd85.js.map
