...
function create_each_block(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(a, file, 64, 4, 1270);
			add_location(br0, file, 65, 4, 1317);
			add_location(br1, file, 67, 4, 1345);
			add_location(br2, file, 68, 4, 1356);
		},
...
function create_fragment(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(input0, file, 55, 0, 1050);
			add_location(br0, file, 56, 0, 1127);
			attr(input1, "class", "blog-description svelte-o63xsf");
			add_location(input1, file, 57, 0, 1134);
			add_location(br1, file, 58, 0, 1203);
			add_location(br2, file, 59, 0, 1210);
			add_location(br3, file, 60, 0, 1217);
			attr(div, "id", "posts");
			add_location(div, file, 62, 0, 1225);
			attr(input2, "class", "new-post-title");
			attr(input2, "placeholder", "Title");
			add_location(input2, file, 73, 0, 1426);
			add_location(br4, file, 74, 0, 1525);
			attr(input3, "class", "new-post-body");
			attr(input3, "placeholder", "Body");
			add_location(input3, file, 75, 0, 1532);
			add_location(button, file, 76, 0, 1609);
			attr(form, "id", "newPost");
			add_location(form, file, 72, 0, 1381);
...
export default Blog;
//# sourceMappingURL=Blog-6e528350.js.map
