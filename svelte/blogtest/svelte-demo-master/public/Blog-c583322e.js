...
function create_each_block(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(a, file, 65, 4, 1314);
			add_location(br0, file, 66, 4, 1361);
			add_location(br1, file, 68, 4, 1389);
			add_location(br2, file, 69, 4, 1400);
		},
...
function create_fragment(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(input0, file, 55, 0, 1097);
			add_location(p, file, 56, 0, 1165);
			add_location(br0, file, 57, 0, 1180);
			attr(input1, "class", "blog-description svelte-1uev76t");
			add_location(input1, file, 58, 0, 1187);
			add_location(br1, file, 59, 0, 1247);
			add_location(br2, file, 60, 0, 1254);
			add_location(br3, file, 61, 0, 1261);
			attr(div, "id", "posts");
			add_location(div, file, 63, 0, 1269);
...
export default Blog;
export { preload };
//# sourceMappingURL=Blog-c583322e.js.map
