...
function create_each_block(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(a, file, 63, 4, 1327);
			add_location(br0, file, 64, 4, 1374);
			add_location(br1, file, 66, 4, 1402);
			add_location(br2, file, 67, 4, 1413);
		},
...
function create_fragment(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(input0, file, 53, 0, 1100);
			add_location(p, file, 54, 0, 1171);
			add_location(br0, file, 55, 0, 1193);
			attr(input1, "class", "blog-description svelte-o63xsf");
			add_location(input1, file, 56, 0, 1200);
			add_location(br1, file, 57, 0, 1260);
			add_location(br2, file, 58, 0, 1267);
			add_location(br3, file, 59, 0, 1274);
			attr(div, "id", "posts");
			add_location(div, file, 61, 0, 1282);
...
export default Blog;
export { preload };
//# sourceMappingURL=Blog-c53dcf54.js.map
