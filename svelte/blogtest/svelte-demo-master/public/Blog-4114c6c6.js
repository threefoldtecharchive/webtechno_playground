...
function create_each_block(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(a, file, 61, 4, 1259);
			add_location(br0, file, 62, 4, 1306);
			add_location(br1, file, 64, 4, 1334);
			add_location(br2, file, 65, 4, 1345);
		},
...
function create_fragment(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(input0, file, 51, 0, 1042);
			add_location(p, file, 52, 0, 1110);
			add_location(br0, file, 53, 0, 1125);
			attr(input1, "class", "blog-description svelte-o63xsf");
			add_location(input1, file, 54, 0, 1132);
			add_location(br1, file, 55, 0, 1192);
			add_location(br2, file, 56, 0, 1199);
			add_location(br3, file, 57, 0, 1206);
			attr(div, "id", "posts");
			add_location(div, file, 59, 0, 1214);
...
export default Blog;
export { preload };
//# sourceMappingURL=Blog-4114c6c6.js.map
