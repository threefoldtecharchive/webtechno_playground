...
function create_each_block(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(a, file, 62, 4, 1314);
			add_location(br0, file, 63, 4, 1361);
			add_location(br1, file, 65, 4, 1389);
			add_location(br2, file, 66, 4, 1400);
		},
...
function create_fragment(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(p, file, 53, 0, 1158);
			add_location(br0, file, 54, 0, 1180);
			attr(input1, "class", "blog-description svelte-o63xsf");
			add_location(input1, file, 55, 0, 1187);
			add_location(br1, file, 56, 0, 1247);
			add_location(br2, file, 57, 0, 1254);
			add_location(br3, file, 58, 0, 1261);
			attr(div, "id", "posts");
			add_location(div, file, 60, 0, 1269);
...
export default Blog;
export { preload };
//# sourceMappingURL=Blog-d4c7c2e1.js.map
