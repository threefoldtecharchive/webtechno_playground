import { S as SvelteComponentDev, i as init, s as safe_not_equal, e as element, t as text, a as space, b as attr, c as add_location, d as insert, f as append, n as noop, g as detach, m as mount_component, h as transition_out, j as check_outros, k as transition_in, l as destroy_component, o as onDestroy, p as group_outros } from './chunk-72bb347c.js';
...
function create_fragment(ctx) {
	...
	return {
		c: function create() {
			...
			a2 = element("a");
			t4 = text("blog");
			attr(a0, "class", a0_class_value = "" + ctx.isActive('home') + " svelte-1hq25gf");
			attr(a0, "href", "/");
			add_location(a0, file, 2, 6, 18);
			attr(li0, "class", "svelte-1hq25gf");
			add_location(li0, file, 2, 2, 14);
			attr(a1, "class", a1_class_value = "" + ctx.isActive('about') + " svelte-1hq25gf");
			attr(a1, "href", "/about");
			add_location(a1, file, 3, 6, 79);
			attr(li1, "class", "svelte-1hq25gf");
			add_location(li1, file, 3, 2, 75);
			attr(a2, "class", a2_class_value = "" + ctx.isActive('blog') + " svelte-1hq25gf");
			attr(a2, "href", "/blog");
			add_location(a2, file, 4, 6, 147);
			attr(li2, "class", "svelte-1hq25gf");
			add_location(li2, file, 4, 2, 143);
			attr(ul, "class", "svelte-1hq25gf");
			add_location(ul, file, 1, 1, 7);
			attr(nav, "class", "svelte-1hq25gf");
		...
		p: function update(changed, ctx) {
			if ((changed.isActive) && a0_class_value !== (a0_class_value = "" + ctx.isActive('home') + " svelte-1hq25gf")) {
				attr(a0, "class", a0_class_value);
			}

			if ((changed.isActive) && a1_class_value !== (a1_class_value = "" + ctx.isActive('about') + " svelte-1hq25gf")) {
				attr(a1, "class", a1_class_value);
			}

			if ((changed.isActive) && a2_class_value !== (a2_class_value = "" + ctx.isActive('blog') + " svelte-1hq25gf")) {
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$.update = ($$dirty = { active: 1 }) => {
		if ($$dirty.active) { $$invalidate('isActive', isActive = str => active === str ? 'selected' : ''); }
	};
...
class Nav extends SvelteComponentDev {
	constructor(options) {
		super(options);
		init(this, options, instance, create_fragment, safe_not_equal, ["active"]);
...
/* src/components/App.svelte generated by Svelte v3.6.7 */
...
function create_fragment$1(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(main, file$1, 2, 0, 18);
		},
...
function instance$1($$self, $$props, $$invalidate) {
	...
	function draw(m, obj) {
		$$invalidate('params', params = obj || {});
		if (m.preload) {
			m.preload();
			$$invalidate('Route', Route = m.default);
		} else {
			$$invalidate('Route', Route = m.default);
		}
	}
	...
	function track(obj) {
		$$invalidate('uri', uri = obj.state || obj.uri);
	...
	$$self.$$.update = ($$dirty = { uri: 1 }) => {
		if ($$dirty.uri) { $$invalidate('active', active = uri.split('/')[1] || 'home'); }
	};
