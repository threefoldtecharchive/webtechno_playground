...
function create_each_block(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(a, file, 61, 4, 1236);
			add_location(br0, file, 62, 4, 1283);
			add_location(br1, file, 64, 4, 1311);
			add_location(br2, file, 65, 4, 1322);
		},
...
function create_fragment(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(input0, file, 51, 0, 1019);
			add_location(p, file, 52, 0, 1087);
			add_location(br0, file, 53, 0, 1102);
			attr(input1, "class", "blog-description svelte-o63xsf");
			add_location(input1, file, 54, 0, 1109);
			add_location(br1, file, 55, 0, 1169);
			add_location(br2, file, 56, 0, 1176);
			add_location(br3, file, 57, 0, 1183);
			attr(div, "id", "posts");
			add_location(div, file, 59, 0, 1191);
...
export default Blog;
export { preload };
//# sourceMappingURL=Blog-14961e01.js.map
