...
function create_fragment(ctx) {
	var title_value, t0, h1, t1_value = post.title, t1, t2, div, raw_value = post.body;

	document.title = title_value = post.title;
	...
	return {
		c: function create() {
			...
			t2 = space();
			div = element("div");
			add_location(h1, file, 67, 0, 1564);
			attr(div, "class", "content svelte-18mipvo");
			add_location(div, file, 69, 0, 1587);
		},
		...
		p: function update(changed, ctx) {
			if ((changed.post) && title_value !== (title_value = post.title)) {
...
export { preload };
//# sourceMappingURL=Article-a8462bfd.js.map
