...
function create_each_block(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(a, file, 55, 6, 1101);
			add_location(br0, file, 56, 3, 1147);
			add_location(br1, file, 58, 1, 1168);
			add_location(br2, file, 59, 1, 1174);
		},
...
function create_fragment(ctx) {
	var t0, input0, t1, br0, t2, input1, t3, br1, t4, div, dispose;
	...
	return {
		c: function create() {
			...
			add_location(br1, file, 51, 0, 1048);
			attr(div, "id", "posts");
			add_location(div, file, 53, 0, 1054);
...
export default Blog;
export { preload };
//# sourceMappingURL=Blog-03eed03b.js.map
