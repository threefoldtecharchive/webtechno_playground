...
function create_each_block(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(a, file, 64, 4, 1344);
			add_location(br0, file, 65, 4, 1391);
			add_location(br1, file, 67, 4, 1419);
			add_location(br2, file, 68, 4, 1430);
		},
...
function create_fragment(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(input0, file, 55, 0, 1124);
			add_location(br0, file, 56, 0, 1201);
			attr(input1, "class", "blog-description svelte-1uev76t");
			add_location(input1, file, 57, 0, 1208);
			add_location(br1, file, 58, 0, 1277);
			add_location(br2, file, 59, 0, 1284);
			add_location(br3, file, 60, 0, 1291);
			attr(div, "id", "posts");
			add_location(div, file, 62, 0, 1299);
...
function editBlog(e) {
  if (e.key === "Enter") {
	  ...
	  blogInfo.description=blogInfo.title;
  }
}
function preload() {
...
export default Blog;
export { preload };
//# sourceMappingURL=Blog-db483ea0.js.map
