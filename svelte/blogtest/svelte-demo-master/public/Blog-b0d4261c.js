...
function create_each_block(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(a, file, 56, 6, 1100);
			add_location(br0, file, 57, 3, 1146);
			add_location(br1, file, 59, 1, 1167);
			add_location(br2, file, 60, 1, 1173);
		},
...
function create_fragment(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(br0, file, 48, 0, 961);
			attr(input1, "class", "blog-description svelte-12qfjnz");
			add_location(input1, file, 49, 0, 968);
			add_location(br1, file, 50, 0, 1037);
			add_location(br2, file, 51, 0, 1042);
			add_location(br3, file, 52, 0, 1047);
			attr(div, "id", "posts");
...
export default Blog;
export { preload };
//# sourceMappingURL=Blog-b0d4261c.js.map
