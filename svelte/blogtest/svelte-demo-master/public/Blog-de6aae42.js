...
function create_each_block(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(a, file, 60, 4, 1201);
			add_location(br0, file, 61, 4, 1248);
			add_location(br1, file, 63, 4, 1276);
			add_location(br2, file, 64, 4, 1287);
		},
...
function create_fragment(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(input0, file, 51, 0, 981);
			add_location(br0, file, 52, 0, 1058);
			attr(input1, "class", "blog-description svelte-1uev76t");
			add_location(input1, file, 53, 0, 1065);
			add_location(br1, file, 54, 0, 1134);
			add_location(br2, file, 55, 0, 1141);
			add_location(br3, file, 56, 0, 1148);
			attr(div, "id", "posts");
			add_location(div, file, 58, 0, 1156);
...
export default Blog;
export { preload };
//# sourceMappingURL=Blog-de6aae42.js.map
