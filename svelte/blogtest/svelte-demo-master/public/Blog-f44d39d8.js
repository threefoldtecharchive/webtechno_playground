...
function create_each_block(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(a, file, 63, 4, 1269);
			add_location(br0, file, 64, 4, 1316);
			add_location(br1, file, 66, 4, 1344);
			add_location(br2, file, 67, 4, 1355);
		},
...
function create_fragment(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(input0, file, 54, 0, 1049);
			add_location(br0, file, 55, 0, 1126);
			attr(input1, "class", "blog-description svelte-o63xsf");
			add_location(input1, file, 56, 0, 1133);
			add_location(br1, file, 57, 0, 1202);
			add_location(br2, file, 58, 0, 1209);
			add_location(br3, file, 59, 0, 1216);
			attr(div, "id", "posts");
			add_location(div, file, 61, 0, 1224);
			attr(input2, "class", "new-post-title");
			attr(input2, "placeholder", "Title");
			add_location(input2, file, 72, 0, 1440);
			add_location(br4, file, 73, 0, 1539);
			attr(input3, "class", "new-post-body");
			attr(input3, "placeholder", "Body");
			add_location(input3, file, 74, 0, 1546);
			add_location(button, file, 75, 0, 1623);
			attr(form, "id", "newPost");
			add_location(form, file, 71, 0, 1380);
...
export default Blog;
//# sourceMappingURL=Blog-f44d39d8.js.map
