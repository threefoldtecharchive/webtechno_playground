...
function create_each_block(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(a, file, 64, 4, 1308);
			add_location(br0, file, 65, 4, 1355);
			add_location(br1, file, 67, 4, 1383);
			add_location(br2, file, 68, 4, 1394);
		},
...
function create_fragment(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(br1, file, 58, 0, 1241);
			add_location(br2, file, 59, 0, 1248);
			add_location(br3, file, 60, 0, 1255);
			attr(div, "id", "posts");
...
export default Blog;
export { preload };
//# sourceMappingURL=Blog-eb056981.js.map
