...
function create_each_block(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(a, file, 65, 4, 1313);
			add_location(br0, file, 66, 4, 1360);
			add_location(br1, file, 68, 4, 1388);
			add_location(br2, file, 69, 4, 1399);
		},
...
function create_fragment(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(input0, file, 56, 0, 1093);
			add_location(br0, file, 57, 0, 1170);
			attr(input1, "class", "blog-description svelte-o63xsf");
			add_location(input1, file, 58, 0, 1177);
			add_location(br1, file, 59, 0, 1246);
			add_location(br2, file, 60, 0, 1253);
			add_location(br3, file, 61, 0, 1260);
			attr(div, "id", "posts");
			add_location(div, file, 63, 0, 1268);
			attr(input2, "class", "new-post-title");
			attr(input2, "placeholder", "Title");
			add_location(input2, file, 74, 0, 1484);
			add_location(br4, file, 75, 0, 1583);
			attr(input3, "class", "new-post-body");
			attr(input3, "placeholder", "Body");
			add_location(input3, file, 76, 0, 1590);
			add_location(button, file, 77, 0, 1667);
			attr(form, "id", "newPost");
			add_location(form, file, 73, 0, 1424);
...
export default Blog;
//# sourceMappingURL=Blog-007d1ed5.js.map
