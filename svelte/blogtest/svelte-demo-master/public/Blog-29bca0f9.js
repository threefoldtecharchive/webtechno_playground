...
function create_each_block(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(a, file, 62, 4, 1337);
			add_location(br0, file, 63, 4, 1384);
			add_location(br1, file, 65, 4, 1412);
			add_location(br2, file, 66, 4, 1423);
		},
...
function create_fragment(ctx) {
	var t0, input0, input0_value_value, t1, p, t2, t3, t4, br0, t5, input1, t6, br1, t7, br2, t8, br3, t9, div, dispose;
	...
	return {
		c: function create() {
			...
			input0.value = input0_value_value = {title};
			add_location(input0, file, 52, 0, 1095);
			add_location(p, file, 53, 0, 1181);
			add_location(br0, file, 54, 0, 1203);
			attr(input1, "class", "blog-description svelte-o63xsf");
			add_location(input1, file, 55, 0, 1210);
			add_location(br1, file, 56, 0, 1270);
			add_location(br2, file, 57, 0, 1277);
			add_location(br3, file, 58, 0, 1284);
			attr(div, "id", "posts");
			add_location(div, file, 60, 0, 1292);
		...
		p: function update(changed, ctx) {
			...
			if ((changed.title) && input0_value_value !== (input0_value_value = {title})) {
...
export default Blog;
export { preload };
//# sourceMappingURL=Blog-29bca0f9.js.map
