...
function create_each_block(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(a, file, 61, 4, 1258);
			add_location(br0, file, 62, 4, 1305);
			add_location(br1, file, 64, 4, 1333);
			add_location(br2, file, 65, 4, 1344);
		},
...
function create_fragment(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(input0, file, 51, 0, 1041);
			add_location(p, file, 52, 0, 1109);
			add_location(br0, file, 53, 0, 1124);
			attr(input1, "class", "blog-description svelte-o63xsf");
			add_location(input1, file, 54, 0, 1131);
			add_location(br1, file, 55, 0, 1191);
			add_location(br2, file, 56, 0, 1198);
			add_location(br3, file, 57, 0, 1205);
			attr(div, "id", "posts");
			add_location(div, file, 59, 0, 1213);
...
export default Blog;
export { preload };
//# sourceMappingURL=Blog-2c15009f.js.map
