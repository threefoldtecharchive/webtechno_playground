...
function create_each_block(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(a, file, 61, 4, 1265);
			add_location(br0, file, 62, 4, 1312);
			add_location(br1, file, 64, 4, 1340);
			add_location(br2, file, 65, 4, 1351);
		},
...
function create_fragment(ctx) {
	var t0, input0, t1, p, t2, t3, br0, t4, input1, t5, br1, t6, br2, t7, br3, t8, div, dispose;
	...
	return {
		c: function create() {
			...
			add_location(input0, file, 51, 0, 1048);
			add_location(p, file, 52, 0, 1116);
			add_location(br0, file, 53, 0, 1131);
			attr(input1, "class", "blog-description svelte-o63xsf");
			add_location(input1, file, 54, 0, 1138);
			add_location(br1, file, 55, 0, 1198);
			add_location(br2, file, 56, 0, 1205);
			add_location(br3, file, 57, 0, 1212);
			attr(div, "id", "posts");
			add_location(div, file, 59, 0, 1220);
...
function preload() {
  ...
  window.gun.get("headline").on(headLine => {
	  title = headLine.title;
		console.log(headLine, "hmmmmmm??", title);
...
export default Blog;
export { preload };
//# sourceMappingURL=Blog-fc5005ca.js.map
