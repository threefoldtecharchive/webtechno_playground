...
function create_each_block(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(a, file, 64, 4, 1342);
			add_location(br0, file, 65, 4, 1389);
			add_location(br1, file, 67, 4, 1417);
			add_location(br2, file, 68, 4, 1428);
		},
...
function create_fragment(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(input0, file, 55, 0, 1122);
			add_location(br0, file, 56, 0, 1199);
			attr(input1, "class", "blog-description svelte-1uev76t");
			add_location(input1, file, 57, 0, 1206);
			add_location(br1, file, 58, 0, 1275);
			add_location(br2, file, 59, 0, 1282);
			add_location(br3, file, 60, 0, 1289);
			attr(div, "id", "posts");
			add_location(div, file, 62, 0, 1297);
...
export default Blog;
export { preload };
//# sourceMappingURL=Blog-6c94c87e.js.map
