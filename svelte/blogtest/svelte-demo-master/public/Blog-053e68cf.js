...
function create_each_block(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(a, file, 62, 4, 1335);
			add_location(br0, file, 63, 4, 1382);
			add_location(br1, file, 65, 4, 1410);
			add_location(br2, file, 66, 4, 1421);
		},
...
function create_fragment(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(p, file, 53, 0, 1179);
			add_location(br0, file, 54, 0, 1201);
			attr(input1, "class", "blog-description svelte-o63xsf");
			add_location(input1, file, 55, 0, 1208);
			add_location(br1, file, 56, 0, 1268);
			add_location(br2, file, 57, 0, 1275);
			add_location(br3, file, 58, 0, 1282);
			attr(div, "id", "posts");
			add_location(div, file, 60, 0, 1290);
...
export default Blog;
export { preload };
//# sourceMappingURL=Blog-053e68cf.js.map
