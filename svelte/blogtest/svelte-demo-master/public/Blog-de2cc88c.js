...
function create_each_block(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(a, file, 55, 6, 1085);
			add_location(br0, file, 56, 3, 1131);
			add_location(br1, file, 58, 1, 1152);
			add_location(br2, file, 59, 1, 1158);
		},
...
function create_fragment(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(br1, file, 51, 0, 1032);
			attr(div, "id", "posts");
			add_location(div, file, 53, 0, 1038);
...
export default Blog;
export { preload };
//# sourceMappingURL=Blog-de2cc88c.js.map
