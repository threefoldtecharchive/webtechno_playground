...
function create_each_block(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(a, file, 62, 4, 1321);
			add_location(br0, file, 63, 4, 1368);
			add_location(br1, file, 65, 4, 1396);
			add_location(br2, file, 66, 4, 1407);
		},
...
function create_fragment(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(p, file, 53, 0, 1165);
			add_location(br0, file, 54, 0, 1187);
			attr(input1, "class", "blog-description svelte-o63xsf");
			add_location(input1, file, 55, 0, 1194);
			add_location(br1, file, 56, 0, 1254);
			add_location(br2, file, 57, 0, 1261);
			add_location(br3, file, 58, 0, 1268);
			attr(div, "id", "posts");
			add_location(div, file, 60, 0, 1276);
...
export default Blog;
export { preload };
//# sourceMappingURL=Blog-39c35599.js.map
