...
function create_each_block(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(a, file, 63, 4, 1251);
			add_location(br0, file, 64, 4, 1298);
			add_location(br1, file, 66, 4, 1326);
			add_location(br2, file, 67, 4, 1337);
		},
...
function create_fragment(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(input0, file, 54, 0, 1031);
			add_location(br0, file, 55, 0, 1108);
			attr(input1, "class", "blog-description svelte-o63xsf");
			add_location(input1, file, 56, 0, 1115);
			add_location(br1, file, 57, 0, 1184);
			add_location(br2, file, 58, 0, 1191);
			add_location(br3, file, 59, 0, 1198);
			attr(div, "id", "posts");
			add_location(div, file, 61, 0, 1206);
			attr(input2, "class", "new-post-title");
			attr(input2, "placeholder", "Title");
			add_location(input2, file, 72, 0, 1422);
			add_location(br4, file, 73, 0, 1521);
			attr(input3, "class", "new-post-body");
			attr(input3, "placeholder", "Body");
			add_location(input3, file, 74, 0, 1528);
			add_location(button, file, 75, 0, 1605);
			attr(form, "id", "newPost");
			add_location(form, file, 71, 0, 1362);
...
export default Blog;
//# sourceMappingURL=Blog-cc8e9e91.js.map
