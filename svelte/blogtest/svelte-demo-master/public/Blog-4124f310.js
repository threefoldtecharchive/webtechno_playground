...
function create_each_block(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(a, file, 64, 4, 1299);
			add_location(br0, file, 65, 4, 1346);
			add_location(br1, file, 67, 4, 1374);
			add_location(br2, file, 68, 4, 1385);
		},
...
function create_fragment(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(br0, file, 56, 0, 1165);
			attr(input1, "class", "blog-description svelte-1uev76t");
			add_location(input1, file, 57, 0, 1172);
			add_location(br1, file, 58, 0, 1232);
			add_location(br2, file, 59, 0, 1239);
			add_location(br3, file, 60, 0, 1246);
			attr(div, "id", "posts");
			add_location(div, file, 62, 0, 1254);
...
export default Blog;
export { preload };
//# sourceMappingURL=Blog-4124f310.js.map
