...
function create_each_block(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(a, file, 58, 6, 1146);
			add_location(br0, file, 59, 3, 1192);
			add_location(br1, file, 61, 1, 1213);
			add_location(br2, file, 62, 1, 1219);
		},
...
function create_fragment(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(input0, file, 49, 0, 930);
			add_location(br0, file, 50, 0, 1007);
			attr(input1, "class", "blog-description svelte-12qfjnz");
			add_location(input1, file, 51, 0, 1014);
			add_location(br1, file, 52, 0, 1083);
			add_location(br2, file, 53, 0, 1088);
			add_location(br3, file, 54, 0, 1093);
			attr(div, "id", "posts");
			add_location(div, file, 56, 0, 1099);
...
export default Blog;
export { preload };
//# sourceMappingURL=Blog-19ff4a53.js.map
