...
function create_each_block(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(a, file, 62, 4, 1316);
			add_location(br0, file, 63, 4, 1363);
			add_location(br1, file, 65, 4, 1391);
			add_location(br2, file, 66, 4, 1402);
		},
...
function create_fragment(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(input0, file, 52, 0, 1090);
			add_location(p, file, 53, 0, 1160);
			add_location(br0, file, 54, 0, 1182);
			attr(input1, "class", "blog-description svelte-o63xsf");
			add_location(input1, file, 55, 0, 1189);
			add_location(br1, file, 56, 0, 1249);
			add_location(br2, file, 57, 0, 1256);
			add_location(br3, file, 58, 0, 1263);
			attr(div, "id", "posts");
			add_location(div, file, 60, 0, 1271);
...
export default Blog;
export { preload };
//# sourceMappingURL=Blog-cfb7a378.js.map
