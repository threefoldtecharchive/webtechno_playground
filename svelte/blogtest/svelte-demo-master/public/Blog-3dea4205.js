...
function create_each_block(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(a, file, 63, 4, 1326);
			add_location(br0, file, 64, 4, 1373);
			add_location(br1, file, 66, 4, 1401);
			add_location(br2, file, 67, 4, 1412);
		},
...
function create_fragment(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(p, file, 54, 0, 1170);
			add_location(br0, file, 55, 0, 1192);
			attr(input1, "class", "blog-description svelte-o63xsf");
			add_location(input1, file, 56, 0, 1199);
			add_location(br1, file, 57, 0, 1259);
			add_location(br2, file, 58, 0, 1266);
			add_location(br3, file, 59, 0, 1273);
			attr(div, "id", "posts");
			add_location(div, file, 61, 0, 1281);
...
export default Blog;
export { preload };
//# sourceMappingURL=Blog-3dea4205.js.map
