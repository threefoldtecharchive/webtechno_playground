...
function create_each_block(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(a, file, 55, 6, 1084);
			add_location(li, file, 54, 4, 1073);
		},
...
function create_fragment(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(ul, file, 52, 0, 1040);
...
export default Blog;
export { preload };
//# sourceMappingURL=Blog-d396bdf4.js.map
