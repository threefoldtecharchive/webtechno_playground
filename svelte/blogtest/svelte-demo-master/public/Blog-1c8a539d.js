...
function create_each_block(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(a, file, 63, 4, 1325);
			add_location(br0, file, 64, 4, 1372);
			add_location(br1, file, 66, 4, 1400);
			add_location(br2, file, 67, 4, 1411);
		},
...
function create_fragment(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(input0, file, 53, 0, 1098);
			add_location(p, file, 54, 0, 1169);
			add_location(br0, file, 55, 0, 1191);
			attr(input1, "class", "blog-description svelte-o63xsf");
			add_location(input1, file, 56, 0, 1198);
			add_location(br1, file, 57, 0, 1258);
			add_location(br2, file, 58, 0, 1265);
			add_location(br3, file, 59, 0, 1272);
			attr(div, "id", "posts");
			add_location(div, file, 61, 0, 1280);
...
export default Blog;
export { preload };
//# sourceMappingURL=Blog-1c8a539d.js.map
