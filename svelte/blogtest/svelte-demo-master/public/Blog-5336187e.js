...
function create_each_block(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(a, file, 61, 4, 1242);
			add_location(br0, file, 62, 4, 1289);
			add_location(br1, file, 64, 4, 1317);
			add_location(br2, file, 65, 4, 1328);
		},
...
function create_fragment(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(input0, file, 52, 0, 1022);
			add_location(br0, file, 53, 0, 1099);
			attr(input1, "class", "blog-description svelte-1uev76t");
			add_location(input1, file, 54, 0, 1106);
			add_location(br1, file, 55, 0, 1175);
			add_location(br2, file, 56, 0, 1182);
			add_location(br3, file, 57, 0, 1189);
			attr(div, "id", "posts");
			add_location(div, file, 59, 0, 1197);
...
export default Blog;
export { preload };
//# sourceMappingURL=Blog-5336187e.js.map
