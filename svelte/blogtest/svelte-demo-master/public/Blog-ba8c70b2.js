...
function create_each_block(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(a, file, 60, 4, 1228);
			add_location(br0, file, 61, 4, 1275);
			add_location(br1, file, 63, 4, 1303);
			add_location(br2, file, 64, 4, 1314);
		},
...
function create_fragment(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(br0, file, 52, 0, 1094);
			attr(input1, "class", "blog-description svelte-o63xsf");
			add_location(input1, file, 53, 0, 1101);
			add_location(br1, file, 54, 0, 1161);
			add_location(br2, file, 55, 0, 1168);
			add_location(br3, file, 56, 0, 1175);
			attr(div, "id", "posts");
			add_location(div, file, 58, 0, 1183);
...
export default Blog;
export { preload };
//# sourceMappingURL=Blog-ba8c70b2.js.map
