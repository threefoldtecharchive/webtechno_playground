...
function create_each_block(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(a, file, 56, 6, 1080);
			add_location(br0, file, 57, 3, 1126);
			add_location(br1, file, 59, 1, 1147);
			add_location(br2, file, 60, 1, 1153);
		},
...
function create_fragment(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(br1, file, 50, 0, 1017);
			add_location(br2, file, 51, 0, 1022);
			add_location(br3, file, 52, 0, 1027);
			attr(div, "id", "posts");
			add_location(div, file, 54, 0, 1033);
...
export default Blog;
export { preload };
//# sourceMappingURL=Blog-cfc2b1e3.js.map
