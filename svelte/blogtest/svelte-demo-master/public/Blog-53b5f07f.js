...
function create_each_block(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(a, file, 64, 4, 1294);
			add_location(br0, file, 65, 4, 1341);
			add_location(br1, file, 67, 4, 1369);
			add_location(br2, file, 68, 4, 1380);
		},
...
function create_fragment(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(input0, file, 55, 0, 1074);
			add_location(br0, file, 56, 0, 1151);
			attr(input1, "class", "blog-description svelte-o63xsf");
			add_location(input1, file, 57, 0, 1158);
			add_location(br1, file, 58, 0, 1227);
			add_location(br2, file, 59, 0, 1234);
			add_location(br3, file, 60, 0, 1241);
			attr(div, "id", "posts");
			add_location(div, file, 62, 0, 1249);
			attr(input2, "class", "new-post-title");
			attr(input2, "placeholder", "Title");
			add_location(input2, file, 73, 0, 1465);
			add_location(br4, file, 74, 0, 1564);
			attr(input3, "class", "new-post-body");
			attr(input3, "placeholder", "Body");
			add_location(input3, file, 75, 0, 1571);
			add_location(button, file, 76, 0, 1648);
			attr(form, "id", "newPost");
			add_location(form, file, 72, 0, 1405);
...
export default Blog;
//# sourceMappingURL=Blog-53b5f07f.js.map
