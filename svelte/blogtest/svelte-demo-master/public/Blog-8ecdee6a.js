...
function create_each_block(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(a, file, 65, 4, 1329);
			add_location(br0, file, 66, 4, 1376);
			add_location(br1, file, 68, 4, 1404);
			add_location(br2, file, 69, 4, 1415);
		},
...
function create_fragment(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(br0, file, 57, 0, 1186);
			attr(input1, "class", "blog-description svelte-1uev76t");
			add_location(input1, file, 58, 0, 1193);
			add_location(br1, file, 59, 0, 1262);
			add_location(br2, file, 60, 0, 1269);
			add_location(br3, file, 61, 0, 1276);
			attr(div, "id", "posts");
			add_location(div, file, 63, 0, 1284);
...
export default Blog;
export { preload };
//# sourceMappingURL=Blog-8ecdee6a.js.map
