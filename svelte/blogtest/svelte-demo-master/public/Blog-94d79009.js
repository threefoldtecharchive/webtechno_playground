...
function create_each_block(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(a, file, 63, 4, 1324);
			add_location(br0, file, 64, 4, 1371);
			add_location(br1, file, 66, 4, 1399);
			add_location(br2, file, 67, 4, 1410);
		},
...
function create_fragment(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(p, file, 54, 0, 1168);
			add_location(br0, file, 55, 0, 1190);
			attr(input1, "class", "blog-description svelte-o63xsf");
			add_location(input1, file, 56, 0, 1197);
			add_location(br1, file, 57, 0, 1257);
			add_location(br2, file, 58, 0, 1264);
			add_location(br3, file, 59, 0, 1271);
			attr(div, "id", "posts");
			add_location(div, file, 61, 0, 1279);
...
export default Blog;
export { preload };
//# sourceMappingURL=Blog-94d79009.js.map
