import { S as SvelteComponentDev, i as init, s as safe_not_equal, e as element, t as text, a as space, b as attr, c as add_location, d as insert, f as append, n as noop, g as detach, q as listen, r as destroy_each, u as run_all, v as validate_store, w as subscribe } from './chunk-ddee6f9f.js';
...
function create_each_block(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(a, file, 64, 4, 1349);
			add_location(br0, file, 65, 4, 1396);
			add_location(br1, file, 67, 4, 1424);
			add_location(br2, file, 68, 4, 1435);
		},
...
function create_fragment(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(input0, file, 54, 0, 1122);
			add_location(p, file, 55, 0, 1193);
			add_location(br0, file, 56, 0, 1215);
			attr(input1, "class", "blog-description svelte-o63xsf");
			add_location(input1, file, 57, 0, 1222);
			add_location(br1, file, 58, 0, 1282);
			add_location(br2, file, 59, 0, 1289);
			add_location(br3, file, 60, 0, 1296);
			attr(div, "id", "posts");
			add_location(div, file, 62, 0, 1304);
...
function instance($$self, $$props, $$invalidate) {
	...
	subscribe($$self, title, $$value => { $title = $$value; $$invalidate('$title', $title); });
...
export default Blog;
export { preload };
//# sourceMappingURL=Blog-0c4bb54e.js.map
