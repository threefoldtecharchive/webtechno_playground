...
function create_each_block(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(a, file, 65, 4, 1309);
			add_location(br0, file, 66, 4, 1356);
			add_location(br1, file, 68, 4, 1384);
			add_location(br2, file, 69, 4, 1395);
		},
...
function create_fragment(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(input0, file, 56, 0, 1089);
			add_location(br0, file, 57, 0, 1166);
			attr(input1, "class", "blog-description svelte-o63xsf");
			add_location(input1, file, 58, 0, 1173);
			add_location(br1, file, 59, 0, 1242);
			add_location(br2, file, 60, 0, 1249);
			add_location(br3, file, 61, 0, 1256);
			attr(div, "id", "posts");
			add_location(div, file, 63, 0, 1264);
			attr(input2, "class", "new-post-title");
			attr(input2, "placeholder", "Title");
			add_location(input2, file, 74, 0, 1480);
			add_location(br4, file, 75, 0, 1579);
			attr(input3, "class", "new-post-body");
			attr(input3, "placeholder", "Body");
			add_location(input3, file, 76, 0, 1586);
			add_location(button, file, 77, 0, 1663);
			attr(form, "id", "newPost");
			add_location(form, file, 73, 0, 1420);
...
export default Blog;
//# sourceMappingURL=Blog-10c138b7.js.map
