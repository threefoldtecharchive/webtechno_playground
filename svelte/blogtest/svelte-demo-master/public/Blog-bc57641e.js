...
function create_each_block(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(a, file, 64, 4, 1340);
			add_location(br0, file, 65, 4, 1387);
			add_location(br1, file, 67, 4, 1415);
			add_location(br2, file, 68, 4, 1426);
		},
...
function create_fragment(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(input0, file, 55, 0, 1120);
			add_location(br0, file, 56, 0, 1197);
			attr(input1, "class", "blog-description svelte-1uev76t");
			add_location(input1, file, 57, 0, 1204);
			add_location(br1, file, 58, 0, 1273);
			add_location(br2, file, 59, 0, 1280);
			add_location(br3, file, 60, 0, 1287);
			attr(div, "id", "posts");
			add_location(div, file, 62, 0, 1295);
...
export default Blog;
export { preload };
//# sourceMappingURL=Blog-bc57641e.js.map
