...
function create_each_block(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(a, file, 60, 4, 1221);
			add_location(br0, file, 61, 4, 1268);
			add_location(br1, file, 63, 4, 1296);
			add_location(br2, file, 64, 4, 1307);
		},
...
function create_fragment(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(input0, file, 50, 0, 1004);
			add_location(p, file, 51, 0, 1072);
			add_location(br0, file, 52, 0, 1087);
			attr(input1, "class", "blog-description svelte-o63xsf");
			add_location(input1, file, 53, 0, 1094);
			add_location(br1, file, 54, 0, 1154);
			add_location(br2, file, 55, 0, 1161);
			add_location(br3, file, 56, 0, 1168);
			attr(div, "id", "posts");
			add_location(div, file, 58, 0, 1176);
...
export default Blog;
export { preload };
//# sourceMappingURL=Blog-b1cee9e6.js.map
