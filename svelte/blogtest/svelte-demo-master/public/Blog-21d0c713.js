...
function create_each_block(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(a, file, 53, 4, 973);
			add_location(br0, file, 54, 4, 1020);
			add_location(br1, file, 56, 4, 1048);
			add_location(br2, file, 57, 4, 1059);
		},
...
function create_fragment(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(input0, file, 44, 0, 753);
			add_location(br0, file, 45, 0, 830);
			attr(input1, "class", "blog-description svelte-o63xsf");
			add_location(input1, file, 46, 0, 837);
			add_location(br1, file, 47, 0, 906);
			add_location(br2, file, 48, 0, 913);
			add_location(br3, file, 49, 0, 920);
			attr(div, "id", "posts");
			add_location(div, file, 51, 0, 928);
			attr(input2, "class", "new-post-title");
			attr(input2, "placeholder", "Title");
			add_location(input2, file, 62, 0, 1104);
			add_location(br4, file, 63, 0, 1203);
			attr(input3, "class", "new-post-body");
			attr(input3, "placeholder", "Body");
			add_location(input3, file, 64, 0, 1210);
			attr(form, "id", "newPost");
			add_location(form, file, 61, 0, 1084);
...
export default Blog;
//# sourceMappingURL=Blog-21d0c713.js.map
