...
function create_each_block(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(a, file, 63, 4, 1398);
			add_location(br0, file, 64, 4, 1445);
			add_location(br1, file, 66, 4, 1473);
			add_location(br2, file, 67, 4, 1484);
		},
...
function create_fragment(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(input0, file, 53, 0, 1172);
			add_location(p, file, 54, 0, 1242);
			add_location(br0, file, 55, 0, 1264);
			attr(input1, "class", "blog-description svelte-o63xsf");
			add_location(input1, file, 56, 0, 1271);
			add_location(br1, file, 57, 0, 1331);
			add_location(br2, file, 58, 0, 1338);
			add_location(br3, file, 59, 0, 1345);
			attr(div, "id", "posts");
...
export default Blog;
export { preload };
//# sourceMappingURL=Blog-e6b82a1b.js.map
