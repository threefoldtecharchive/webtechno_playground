...
function create_each_block(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(a, file, 66, 4, 1372);
			add_location(br0, file, 67, 4, 1419);
			add_location(br1, file, 69, 4, 1447);
			add_location(br2, file, 70, 4, 1458);
		},
...
function create_fragment(ctx) {
	...
	return {
		c: function create() {
			...
			add_location(input0, file, 57, 0, 1161);
			add_location(br0, file, 58, 0, 1229);
			attr(input1, "class", "blog-description svelte-1uev76t");
			add_location(input1, file, 59, 0, 1236);
			add_location(br1, file, 60, 0, 1305);
			add_location(br2, file, 61, 0, 1312);
			add_location(br3, file, 62, 0, 1319);
			attr(div, "id", "posts");
			add_location(div, file, 64, 0, 1327);
...
export default Blog;
export { preload };
//# sourceMappingURL=Blog-8e21bf45.js.map
